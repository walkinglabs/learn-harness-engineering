...
这个项目 05 起始项目是进行对话历史角色分离练习之前的项目 04 应用。它有架构规则和清洁状态检查清单，但有意不包含完整的综合项目 harness 文件。
...
不要假定此起始项目存在 `feature_list.json`、`claude-progress.md`、`init.sh` 或 `session-handoff.md`。

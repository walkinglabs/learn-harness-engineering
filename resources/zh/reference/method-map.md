...
| 失败模式 | 实际表现 | 首要修复 | 主要工件 |
| --- | --- | --- | --- |
| 冷启动混乱 | 新会话花大量时间重新摸索状态和启动方式 | 让仓库成为 system of record | `claude-progress.md` |
| 范围蔓延 | 一次启动多个功能，最后没有一个完整收尾 | 限制 active scope | `feature_list.json` |
| 提前宣布完成 | 代码改了就说 done，但没有可运行证据 | 把完成绑定到验证证据 | `clean-state-checklist.md` |

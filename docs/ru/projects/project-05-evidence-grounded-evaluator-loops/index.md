...
Выберите содержательную фичу-апгрейд (многоходовой диалог, редизайн панели цитирования или фильтрация транскриптов) и удерживайте её одинаковой во всех запусках.
...
Самопроверка + debrief report с обоснованием + завершение по доказательствам

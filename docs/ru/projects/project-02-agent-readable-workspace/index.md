...
Добавьте «читаемость» в репозиторий, чтобы новый агент мог быстро понять структуру проекта, узнать текущий прогресс и продолжить работу. Конкретно: реализуйте импорт транскриптов, просмотр деталей документа и локальное хранение, выполнив всё за две сессии.

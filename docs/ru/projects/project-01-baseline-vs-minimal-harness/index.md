...
Соберите минимальный каркас Electron-приложения interview debrief — окно со списком интервью-сессий слева, панелью debrief report справа и локальной директорией данных. Сама задача несложная. Сложно — заставить агента её выполнить.

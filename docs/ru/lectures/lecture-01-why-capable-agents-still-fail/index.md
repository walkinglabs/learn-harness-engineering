...
**Привязывайте каждый провал к конкретному слою.** Не ограничивайтесь «модель тупит». Спросите: задача была размыта? Контекста не хватало? Не было способов верификации? Сопоставьте каждый провал с одним из пяти слоёв выше. Выработайте эту привычку — и в ваших логах «модель недостаточно хороша» будет всплывать всё реже.

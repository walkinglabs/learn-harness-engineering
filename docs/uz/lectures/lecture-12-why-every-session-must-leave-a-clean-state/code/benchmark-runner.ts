...
const benchmarkTasks: BenchmarkTask[] = [
  {
    id: “bench-001”,
    name: “Import markdown transcript”,
    category: “Transcript Pipeline”,
    passCriteria: [“Transcript accepted”, “Segments created”, “Metadata stored”],
  ...
  {
    id: “bench-002”,
    name: “Import timestamped transcript PDF”,
    category: “Transcript Pipeline”,
    passCriteria: [“Transcript accepted”, “Transcript turns parsed”, “Segments created”, “Metadata stored”],
  ...
  {
    id: “bench-003”,
    name: “Analyze system-design answer”,
    category: “Debrief Pipeline”,
    passCriteria: [“Query received”, “Relevant transcript evidence selected”, “Answer generated”, “Evidence references present”],
  ...
  {
    id: “bench-004”,
    name: “Analyze answer with no supporting transcript evidence”,
    category: “Debrief Pipeline”,
    passCriteria: [“Query received”, “Graceful 'no results' message”, “No hallucinated evidence references”],
    expectedDurationMs: 400,
    actualDurationMs: 420,
    actualPass: false,
    failureReason: “Model hallucinated an evidence reference instead of saying 'no results'”,
  },
  {
    id: “bench-005”,
    name: “Delete imported transcript”,
    category: “Transcript Pipeline”,
    passCriteria: [“Transcript removed from session list”, “segments removed from analysis store”, “No orphan data”],

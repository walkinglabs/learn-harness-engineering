  ...
  return [
    {
      ...
      durationMs: 45,
      success: true,
      input: { filename: "interview-transcript.md", size: "2.3MB" },
      output: { segments: 47 },
    },
    {
    ...
    },
    {
      ...
      output: { answer: "I could not find transcript-backed evidence.", evidenceReferences: 0 },
    },
  ];
}
